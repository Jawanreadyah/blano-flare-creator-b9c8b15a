...
function App() {
  ...
  useEffect(() => {
    if (!clickSoundRef.current) {
      clickSoundRef.current = new Audio('https://od.lk/s/OTBfNDQwMDI1ODFf/Mouse%20Click%20-%20Sound%20Effect%20%28HD%29.mp3');
    ...
    const handleClick = () => {
      if (clickSoundRef.current && !isMuted) {
        ...
        clickSoundRef.current.play().catch(error => console.log("Click sound failed:", error));
      }
    };
